...
namespace DNWS
{
    class PM25Plugin : IPlugin
    {
        ...
        public HTTPResponse GetResponse(HTTPRequest request)
        {
            ...
            string JsonResponse = JsonSerializer.Serialize(pm25reading);
            response.body = Encoding.UTF8.GetBytes(JsonResponse);
            response.type = "application/json"; // Set content type to JSON
            return response;
        }
